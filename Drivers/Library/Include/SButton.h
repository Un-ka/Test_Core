...
{
  public:
    SButton(GPIO_TypeDef *GPIOx_IN, uint16_t GPIO_Pin_IN,
            bool type, bool dir);                                               // конструктор кнопки, принимает порт, пин,
                                                                                // тип type (HIGH_PULL / LOW_PULL)
                                                                                // и направление dir (NORM_OPEN / NORM_CLOSE)
														                                                    // HIGH_PULL - кнопка подключена к GND,
                                                                                // пин подтянут к VCC
														                                                    // LOW_PULL - кнопка подключена к VCC,
                                                                                // пин подтянут к GND
